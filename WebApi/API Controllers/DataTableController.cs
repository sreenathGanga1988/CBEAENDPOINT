...
namespace WebApi.Controllers
{
    ...
    public class DataTableController : ControllerBase
    {
        ...
        public DataTableController(IUnitOfWork unitOfWork)
        {
        ...
        public ActionResult PostDataTable([FromBody] DtParameters dtParameters)
        {
            ...
            try
            {
                ...
                if (dtParameters.Listtype == "ACTIVEMEMBER")
                {
                    ...
                    if (!string.IsNullOrEmpty(searchBy))
                    {
                        ...
                        result = result.Where(u => u.StatusId == 3);
                        ...
                        var result1 = result
                            ...
                            .ToList();
                        return Ok(new DtResult<Member> { Draw = dtParameters.Draw, RecordsTotal = totalResultsCount, RecordsFiltered = filteredResultsCount, Data = result1 }); ;
                    }
                    else
                    {
                ...
                else if (dtParameters.Listtype == "USER")
                {
                    ...
                    if (!string.IsNullOrEmpty(searchBy))
                    {
                        ...
                        var result1 = result
                            ...
                            .Take(dtParameters.Length)
                            .ToList();
                        return Ok(new DtResult<User> { Draw = dtParameters.Draw, RecordsTotal = totalResultsCount, RecordsFiltered = filteredResultsCount, Data = result1 }); ;
                    }
                    else
                    {
