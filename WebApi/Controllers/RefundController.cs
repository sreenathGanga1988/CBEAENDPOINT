...
namespace WebApp.Controllers
{
    ...
    public class RefundController : AdminBaseController
    {
        private readonly ILogger<RefundController> _logger;

        string apiUrl = "api/Refund" +
            "";
        public RefundController(ILogger<RefundController> logger, IHttpContextAccessor contextAccessor) : base(contextAccessor)
        {
            _logger = logger;
