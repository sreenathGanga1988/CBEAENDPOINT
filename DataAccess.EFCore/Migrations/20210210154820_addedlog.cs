    ...
    public partial class addedlog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomErrorLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomErrorLogs_User_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "User",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomErrorLogs_User_ModifiedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomErrorLogs_CreatedByUserId",
                table: "CustomErrorLogs",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomErrorLogs_ModifiedByUserId",
                table: "CustomErrorLogs",
