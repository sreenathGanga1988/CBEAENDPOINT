...
namespace DataAccess.EFCore.Migrations
{
    ...
    [Migration("20220826113905_addedauditlog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.App_EntityLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("DisplayAction")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.CustomErrorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Entities.DeathClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("StaffNoNavigationStaffNo")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StaffNoNavigationStaffNo");

                    b.HasIndex("StateId");

                    b.ToTable("DeathClaim");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MemberDefaultTemp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("YearMonthName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RefundContribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Entities.DeathClaim", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Member", "StaffNoNavigation")
                        .WithMany()
                        .HasForeignKey("StaffNoNavigationStaffNo");
