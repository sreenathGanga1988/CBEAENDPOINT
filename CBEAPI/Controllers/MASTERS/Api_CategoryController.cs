    ...
    public class Api_CategoryController : Api_BaseController
    {
        ...
        public CustomApiResponse GetCategory()
        {
            ...
            try
            {
                ...
                {
                    var items = _unitOfWork.Category.GetFilteredPaginatedData("Category","",0,0);
        ...
        [HttpGet()]
        [Route("GetPageCategory")]
        public CustomApiResponse GetPageCategory(PageParameter pageParameter)
        {
            CustomApiResponse response = new CustomApiResponse();
